...
final _wrap = MathUtil.wrap;
final _arcHav = MathUtil.arcHav;
final _havDistance = MathUtil.havDistance;
...
class SphericalUtil {
  ...
  static double computeHeading(LatLng from, LatLng to) {
    ...
    return _wrap(toDegrees(heading), -180, 180);
  }
  ...
  static double distanceRadians(
    ...
    return _arcHav(_havDistance(lat1, lat2, lng1 - lng2));
  }
